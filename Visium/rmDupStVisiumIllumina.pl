...
Description:
	This script filters 10x Genomics Visium BAM files to retain only unique alignments (NH:i:1) while removing secondary, duplicate, and supplementary alignments. It also filters based on sequence uniqueness and preserves cellular barcode (CB) and UMI (UB) information.
