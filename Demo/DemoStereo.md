...
Users can directly repeat all the analysis by following our step-by-step workflow in this file.
...
Afterward,  replace the pointer file in `Demo/StereoSeq/Data` and verify the file integrity using `md5sum`.
